  ...
  return (
    <section id="about" className="bg-background !py-12 md:!py-16 lg:!py-20">
      <div className="container">
        <div className="relative w-full rounded-2xl overflow-hidden shadow-2xl lg:aspect-video">
          {/* Background Image */}
          {backgroundImage && (
            <Image
          ...
          {/* Content Wrapper */}
          <div className="
            relative z-10 flex flex-col p-4 sm:p-6 
            lg:p-0 lg:absolute lg:inset-0 lg:block
          ">
            
            {/* Badge container: On mobile/tablet, it is a flex column. On desktop, it is a relative block for absolute children. */}
            <div className="order-1 flex flex-col gap-3 lg:order-none lg:p-8 lg:relative lg:h-full">
            ...
            {/* Text Card Container */}
            <div className="order-2 mt-4 lg:mt-0 lg:absolute lg:bottom-8 lg:left-8 lg:w-[45%] lg:max-w-lg">
