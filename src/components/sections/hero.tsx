...
export default function Hero({ onScheduleClick }: HeroProps) {
  ...
  return (
    <section ref={heroRef} id="hero" className="relative min-h-[calc(100vh-5rem)] flex items-center justify-center overflow-hidden !p-0">
      ...
      <div className="absolute inset-x-0 top-0 h-[15%] bg-gradient-to-b from-background to-transparent"></div>
      <div className="absolute inset-x-0 bottom-0 h-[15%] bg-gradient-to-t from-background to-transparent"></div>
